...
def create_mail_template_verify_user(verification_link, logo_url):
    subject = "Verify Your Email Address - PuraVida GmbH"
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <div style="background-color: #f5f5f5;">
            <div style="background-color: #ffffff; margin: 0 auto; max-width: 600px;">
                <div style="padding: 20px 0; text-align: center;">
                    <img src="{logo_url}" alt="PuraVida Logo" style="max-width: 100%; height: auto;">
                </div>
                <div style="padding: 20px; text-align: center;">
                    <h1 style="color: #333333;">Welcome to PuraVida GmbH</h1>
...
def create_mail_template_document_update(user_name, logo_url):
    subject = "Document update - PuraVida GmbH"
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
        <div style="background-color: #f5f5f5;">
            <div style="background-color: #ffffff; margin: 0 auto; max-width: 600px;">
                ...
                <div style="padding: 20px; text-align: center;">
                    <h1 style="color: #333333;">Welcome back to PuraVida GmbH {user_name}</h1>
...
def send_notification_mail(user_name, email_recipient):
    ...
    if mail:
        ...
        subject, html_content = create_mail_template_document_update(user_name, logo_url)
...
def send_verify_user_mail(user_name, verification_link, email_recipient):
    ...
    if mail:
        # Render and send the email using Flask's render_template_string function
        logo_url = url_for('static', filename='logo.png', _external=True)
        subject, html_content = create_mail_template_verify_user(verification_link, logo_url)
        rendered_html = render_template_string(html_content)
